  ...
  return (
    <section className="flex flex-1 flex-col justify-center gap-8">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between lg:gap-12">
        ...
        <p className="max-w-96 self-start text-sm lg:text-base uppercase leading-snug tracking-[0.05em]">
          {tagline}
        </p>
      </div>

      <div className="flex flex-col-reverse gap-6 lg:flex-row lg:items-end lg:justify-between lg:gap-12">
        ...
        <h2 className="self-end whitespace-nowrap text-right font-duvel uppercase leading-[0.75] tracking-widest text-[clamp(4rem,21vw,16rem)] lg:text-[clamp(3.25rem,17vw,16rem)]">
          {lastName}
        </h2>
      </div>
    </section>
